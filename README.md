...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-vu5b8e.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-vu5b8e.containers.anotherwebservice.com/
...
```
git clone git@github.com:skwerrul/container-vu5b8e.git
cd container-vu5b8e
```
...
```
docker attach container-vu5b8e
```
